...
| GitHub checks | CPU, host C++, formatting, figure layout, documentation, and Lean pass | [CI record](ci.json) |
| Manuscript GitHub build | Fresh Ubuntu build; 17 pages, 12 figure captions, embedded fonts, no overfull boxes | [Paper CI record](paper-ci.json) |
