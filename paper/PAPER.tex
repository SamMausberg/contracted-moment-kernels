...
% Keep URL hostnames intact while allowing breaks in long revision hashes.
\def\UrlBreaks{\do\/\do\-\do\_\do0\do1\do2\do3\do4\do5\do6\do7\do8\do9}
...
\makeatletter
% Top-align dedicated figure pages and use a fixed gap between their floats.
\setlength{\@fptop}{0pt}
...
\begin{document}
% Keep natural paragraph spacing and avoid words split across figure-heavy pages.
\raggedbottom
\brokenpenalty=10000
\clubpenalty=10000
\widowpenalty=10000
...
\appendix
\onecolumn
\input{sections/theory_appendix}
\input{sections/formalization}
\input{sections/experiments_appendix}
