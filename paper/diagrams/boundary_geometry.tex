...
\begin{tikzpicture}[font=\small, line cap=round, line join=round,
  ...
  \draw[cmkgreen!65,densely dotted] (1.4,0.35)--(1.4,3.14);
  \draw[cmkgreen!65,densely dotted] (4.6,0.35)--(4.6,2.86);
  \draw[cmkblue,thick] (0,3.875)--(6,0.725);
  \draw[cmkorange,thick] (0,5.275)--(6,2.125);
  % An aligned legend identifies the strokes without detached curve labels.
  \draw[cmkblue,thick] (3.25,5.2)--(3.65,5.2);
  \node[anchor=west,text=cmkblue] at (3.75,5.2)
    {$\mathcal L(c)=2-3c$};
  \draw[cmkorange,thick] (3.25,4.7)--(3.65,4.7);
  \node[anchor=west,text=cmkorange] at (3.75,4.7)
    {$\mathcal U(c)=4-3c$};
  ...
  \foreach \x/\lab in {0/0.25,1.4/0.6,3/1,4.6/1.4,6/1.75} {
    \draw (\x,0.35)--(\x,0.27);
    \node[anchor=north,font=\small] at (\x,0.24) {$\lab$};
  }
  \foreach \y/\lab in {0.9/-3,1.6/-2,2.3/-1,3/0,3.7/1,4.4/2,5.1/3} {
    \draw (0,\y)--(-0.07,\y);
    \node[anchor=east,font=\small] at (-0.09,\y) {$\lab$};
  }
  \node[anchor=north,align=center,text=cmkgreen,font=\small]
    at (3,-0.25)
  ...
  \begin{scope}[xshift=8cm]
    ...
    \foreach \x/\lab in {1.1/0.6,5.5/1.4} {
      ...
      \node[anchor=north,font=\small] at (\x,4.45) {$\lab$};
    }
    ...
    \foreach \x/\lab in {{5.5*(2/3-0.4)}/{2/3},{5.5*(4/3-0.4)}/{4/3}} {
      ...
      \node[anchor=north,font=\small] at ({\x},2.9) {$\lab$};
    }
    ...
    \foreach \x/\lab in {0.55/0.5,6.05/1.5} {
      ...
      \node[anchor=north,font=\small] at (\x,1.35) {$\lab$};
    }
    ...
    \node[anchor=north,font=\small] at (3.3,-0.25)
