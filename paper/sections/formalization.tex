...
\code{gated_residual_identity} & Exact smooth-gate residual identity. \\
\code{gated_remainder_bound} & Smooth-gate error bound under a Taylor witness. \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{equation}
 ...
 &\quad=p_1\alpha\gamma+(p-p_0-p_1\alpha)(s+\gamma).
 \end{split}
...
\end{equation}
Lean proves the identity and bound; \cref{tab:formalization} lists their declarations.
